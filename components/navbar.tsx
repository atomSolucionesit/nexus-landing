        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="flex items-center gap-3 animate-fade-in">
            <div className="relative w-10 h-10 md:w-12 md:h-12 transition-transform hover:scale-110 duration-300">
              <Image src="/images/logo-nexus.png" alt="Nexus Logo" fill className="object-contain" priority />
            </div>
          ...
          <div className="flex items-center gap-3 md:gap-4 animate-fade-in-delay">
            ...
            <Button className="text-sm md:text-base bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90 shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300">
              Probar Nexus
            </Button>
          </div>
        </div>
