      ...
      <div className="container mx-auto px-4 py-20 sm:px-6 lg:px-8 lg:py-32">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
          ...
          <div className="relative lg:order-last animate-fade-in-right">
            ...
            >
              {/* Glow detrás de la imagen — separado para no afectar nitidez */}
              <div className="absolute inset-0 bg-gradient-to-r from-primary/20 to-accent/20 blur-3xl rounded-full scale-110 animate-pulse -z-10" />
              <Image
