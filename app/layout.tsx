...
export const metadata: Metadata = {
  ...
  title: {
    default: "Nexus | Sistema de Gestión para Distribuidoras y Mayoristas",
    template: "%s | Nexus",
  },
  description: "Nexus es un sistema SaaS de gestión comercial para distribuidoras, mayoristas e importadoras. Centralizá stock multi-depósito, pedidos, logística, cuentas corrientes y canales de venta en una sola plataforma. Prueba gratis 30 días.",
  keywords: [
    "nexus",
    "software para distribuidoras",
    "sistema para mayoristas",
    "gestión de distribuidoras",
    "software mayorista argentina",
    "sistema de gestión comercial",
    "saas distribuidoras",
    "stock multi depósito",
    "pedidos mayoristas",
    "cuentas corrientes mayoristas",
    "trazabilidad de pedidos",
    "gestión de repartidores",
    "software importadoras",
    "punto de venta",
    "POS",
    "stock",
    "inventario",
  ...
  openGraph: {
    ...
    url: siteUrl,
    siteName: "Nexus CRM",
    title: "Nexus | Sistema de Gestión para Distribuidoras y Mayoristas",
    description: "Centralizá stock multi-depósito, pedidos, logística y cuentas corrientes de tu distribuidora o mayorista en una sola plataforma. Prueba gratis 30 días.",
    images: [
      {
  ...
  twitter: {
    ...
    title: "Nexus | Sistema de Gestión para Distribuidoras y Mayoristas",
    description: "Sistema SaaS para distribuidoras y mayoristas. Gestión de stock, pedidos y logística en tiempo real.",
  ...
  other: {
    ...
    "target-audience": "Distribuidoras, mayoristas, importadoras, ferreterías, empresas con volumen de ventas",
    ...
    "industries": "Distribuidoras, Mayoristas, Importadoras, Ferreterías, Retail con volumen",
...
export default function RootLayout({
  ...
  const softwareApplicationSchema = {
    ...
    "@type": "SoftwareApplication",
    "@id": `${siteUrl}#software`,
    name: "Nexus | Sistema de Gestión para Distribuidoras y Mayoristas",
    alternateName: ["Nexus", "Nexus Software"],
    applicationCategory: "BusinessApplication",
    applicationSubCategory: "ERP Software, CRM Software, Gestión de Distribuidoras",
